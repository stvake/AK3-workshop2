...
#define DUTY_RED 76 	// PD14 (Channel 3)
#define DUTY_GREEN 69 	// PD12 (Channel 1)
#define DUTY_ORANGE 48 	// PD13 (Channel 2)
#define DUTY_BLUE 50 	// PD15 (Channel 4)

#define TIM4_ARR 3425 	// ARR value = timer_clock(16MHz) / frequency(4670) - 1 ~= 3425
...
int main(void)
{
  ...
  TIM4->CCR4 = (TIM4_ARR + 1) * DUTY_BLUE / 100; 	// PD15 (Blue)
